...
namespace RSH.Node.Servers.Netbase;
...
public class TcpServer : IDisposable
{
    ...
    /// </remarks>
    public int OptionAcceptorBacklog { get; set; } = 100_000_000;
    ...
    // Server acceptor
    public Socket AcceptorSocket = null!;
    public SocketAsyncEventArgs AcceptorEventArg = null!;
    ...
    public virtual bool Stop(bool closeSessions)
    {
    ...
    /// </summary>
    public bool IsSocketDisposed { get; set; } = true;
